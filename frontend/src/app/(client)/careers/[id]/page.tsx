            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="border-b border-white/10 pb-8 mb-12">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            <h1 className="text-3xl md:text-5xl font-light tracking-wide mb-4 text-white">
                                {job.title}
                            </h1>
                        ...
                        <a
                            ...
                            className="inline-block bg-white text-black px-8 py-3 text-sm tracking-widest hover:bg-green-300 transition-colors text-center rounded-full font-medium"
                        >
                            APPLY NOW
                        </a>
                    </div>
                ...
                <div className="space-y-8 glass p-10 rounded-2xl border-white/10 bg-black/20">
                    <div>
                        <h2 className="text-lg font-bold tracking-widest mb-4 text-green-300">
                            DESCRIPTION
                        </h2>
