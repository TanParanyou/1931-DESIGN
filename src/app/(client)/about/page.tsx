        ...
        <div className="pt-32 pb-24 px-6 max-w-[1920px] mx-auto min-h-screen">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8 glass p-10 rounded-2xl border-white/10 bg-black/20">
                    <h2 className="text-2xl font-light tracking-wide text-green-200">
                        1931 Co., Ltd.
                    </h2>
                    <p className="text-white/80 leading-relaxed font-light text-lg">
                        The diversity of our team enables us to create a broad range of
                        architectural and Decoration styles. From modern and striking, to
                        contemporary and traditional. We approach each project differently and
                        believe that each one should have its own distinctive character.
                    </p>
                    {/* <p className="text-white/80 leading-relaxed font-light text-lg">
